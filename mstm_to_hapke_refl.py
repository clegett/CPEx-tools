...
data = [[0 for i in range(9)] for j in range(len(fileList))]
...
# I'll declare the s11index and extSearchString variables to the fixed 
    ...
    with open(currentfile) as f:
        ...
        for line in f :
            ...
            #  scattering matrix data and we're going to read it
                ...
                # Calculate phase function (See Bohren and Huffman pp 383-384)
